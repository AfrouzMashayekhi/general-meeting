...
class NetworkImpl {
    ...
    getContract(chaincodeId, name = '', collections) {
        ...
        if (!contract) {
            contract = new Contract(this, chaincodeId, name, collections);
    ...
    async addCommitListener(listener, peers, transactionId) {
        const sessionSupplier = () => new commitlistenersession_1.CommitListenerSession(listener, this.eventServiceManager, peers, transactionId);
    ...
    newBlockListenerSession(listener, options) {
